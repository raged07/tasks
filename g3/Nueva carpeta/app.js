(function ($) {
  ...
  var assetLoader = (function() {
    ...
    this.imgs        = {
      ...
      'avatar_normal' : 'imgs/narutor.png',
  ...
  var player = (function(player) {
    ...
    // spritesheets
    player.sheet     = new SpriteSheet('imgs/narutor.png', player.width, player.height);
    player.walkAnim  = new Animation(player.sheet, 4, 5, 15);
